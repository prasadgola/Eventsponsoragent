...
from routers import email, sponsors, events, tracking, airtable, payments, leads, oauth
...
app.add_middleware(
    ...
    allow_origins=[
        "http://localhost:8080",
        "http://127.0.0.1:8080",
        "https://storage.googleapis.com"  # ← GCS static frontend
    ],
...
app.include_router(oauth.router, prefix="/oauth", tags=["OAuth"])  # ← NEW
